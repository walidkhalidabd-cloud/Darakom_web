...
import { useNavigate } from 'react-router-dom'; // إضافة استيراد التوجيه
import { 
...
const ProviderDashboard = () => {
    ...
    // دالة التبديل لحساب العميل
    const handleSwitchToClient = () => {
        // التوجيه إلى مسار لوحة تحكم العميل (تأكد من أن هذا المسار متطابق مع ملف App.jsx أو الـ Router لديك)
        ...
        <div className="d-flex" style={{ minHeight: '100vh', backgroundColor: '#f8f9fa', fontFamily: "'Tajawal', sans-serif" }} dir="rtl">
            ...
            <div className="flex-grow-1 d-flex flex-column" style={{ overflowX: 'hidden' }}>
                ...
                <main className="flex-grow-1 p-4" style={{ overflowY: 'auto' }}>
                    {activeTab === 'dashboard' && <ProviderDashboardTab />}
