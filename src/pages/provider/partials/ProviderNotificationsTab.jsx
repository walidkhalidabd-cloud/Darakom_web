...
import { fetchNotifications, markAllNotificationsRead } from '../../../services/api/providerApi';
    ...
    <div className="mx-auto" style={{ maxWidth: '1000px' }}>
      ...
      <div className="d-flex flex-column gap-3">
        {notifications.length > 0 ? notifications.map(n => (
          <div key={n.id} className={`card-provider d-flex align-items-start gap-3 p-4 position-relative ${!n.is_read ? 'bg-white shadow-sm border-end border-4 border-warning' : 'bg-light opacity-75 border'}`}
