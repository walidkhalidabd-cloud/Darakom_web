...
const DashboardTab = ({ setActiveTab }) => {
  ...
  const projects = {
    inProgress: [
      { id: 1, title: 'بناء عظم - مساحة 400م', location: 'دمشق، المزة', progress: 65, deadline: '2026/11/01', provider: 'مؤسسة الأساس المتين' },
      { id: 2, title: 'تشطيب شقة سكنية 120م', location: 'حلب، حي الجميلية', progress: 35, deadline: '2026/09/15', provider: 'شركة أطياف للتشطيبات' },
    ],
    pending: [
      { id: 3, title: 'تصميم داخلي لفيلا مودرن', location: 'اللاذقية، الكورنيش', progress: 0, deadline: 'بانتظار البدء', provider: 'م. خالد عبدالله', offersCount: 5 },
      { id: 4, title: 'تركيب سيراميك ورخام', location: 'حمص، حي المحطة', progress: 0, deadline: 'بانتظار الترسية', provider: 'لم يتم الترسية بعد', offersCount: 3 },
    ],
    completed: [
      { id: 5, title: 'أعمال سباكة كاملة', location: 'دمشق، المهاجرين', progress: 100, deadline: '2026/03/10', provider: 'فني سباكة - أحمد', rating: 4.5 },
      { id: 6, title: 'دهان وتشطيب داخلي', location: 'طرطوس, مشروع دمر', progress: 100, deadline: '2026/01/20', provider: 'شركة الشام للمقاولات', rating: 4.8 },
    ]
  };
        ...
        <div className="row g-3">
          <div className="col-md-3 col-6">
            <div className="card border-0 shadow-sm rounded-4 p-3 p-md-4 d-flex flex-row align-items-center justify-content-between h-100" style={{ transition: '0.3s' }}>
              <div><p className="text-muted fw-bold mb-1" style={{ fontSize: '18px' }}>إجمالي المشاريع</p><h3 className="fw-bold mb-0" style={{ fontSize: '32px' }}>6</h3></div>
              <div className="bg-primary bg-opacity-10 text-primary p-3 rounded-circle fs-4"><FaListAlt /></div>
            </div>
          </div>
          <div className="col-md-3 col-6">
            <div className="card border-0 shadow-sm rounded-4 p-3 p-md-4 d-flex flex-row align-items-center justify-content-between h-100" style={{ transition: '0.3s' }}>
              <div><p className="text-muted fw-bold mb-1" style={{ fontSize: '18px' }}>قيد الإنشاء</p><h3 className="fw-bold mb-0" style={{ fontSize: '32px' }}>2</h3></div>
              <div className="bg-warning bg-opacity-10 text-warning p-3 rounded-circle fs-4"><FaSpinner /></div>
            </div>
          </div>
          <div className="col-md-3 col-6">
            <div className="card border-0 shadow-sm rounded-4 p-3 p-md-4 d-flex flex-row align-items-center justify-content-between h-100" style={{ transition: '0.3s' }}>
              <div><p className="text-muted fw-bold mb-1" style={{ fontSize: '18px' }}>مكتملة</p><h3 className="fw-bold mb-0" style={{ fontSize: '32px' }}>2</h3></div>
              <div className="bg-success bg-opacity-10 text-success p-3 rounded-circle fs-4"><FaCheckCircle /></div>
            </div>
          </div>
          <div className="col-md-3 col-6">
            <div className="card border-0 shadow-sm rounded-4 p-3 p-md-4 d-flex flex-row align-items-center justify-content-between h-100" style={{ transition: '0.3s' }}>
              <div><p className="text-muted fw-bold mb-1" style={{ fontSize: '18px' }}>عروض بانتظارك</p><h3 className="fw-bold mb-0" style={{ fontSize: '32px' }}>12</h3></div>
